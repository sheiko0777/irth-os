    ...
    return (
        <>
            ...
            >
                ...
                {count > 0 && (
                    <span className="absolute top-1 right-1 h-4 w-4 rounded-full bg-[var(--crimson)] text-white text-[10px] font-bold flex items-center justify-center leading-none">
                        {count > 9 ? '9+' : count}
                    </span>
                )}
            </button>
