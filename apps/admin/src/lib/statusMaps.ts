...
const tone = {
  ...
  azure: { color: "var(--info)", bg: "var(--info-bg)" },
  crimson: { color: "var(--critical)", bg: "var(--critical-bg)" },
  gold: { color: "var(--warning)", bg: "var(--warning-bg)" },
  emerald: { color: "var(--success)", bg: "var(--success-bg)" },
  muted: { color: "var(--text-secondary)", bg: "var(--raised)" },
  neutral: { color: "var(--text-secondary)", bg: "var(--raised)" },
} as const;
