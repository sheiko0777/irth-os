...
const ACTION_OVERRIDES: Partial<Record<Resource, Record<string, string>>> = {
  ...
  customers: { assign: 'إسناد عميل لمندوب مبيعات' },
  purchasing: { pay: 'تسجيل دفعة لمورد', portalAccounts: 'حساب بوابة للمورد' },
  portal: { respond: 'تأكيد أمر الشراء أو اقتراح موعد', ship: 'إشعار شحن', payments: 'كشف الحساب والسداد' },
  sales: { customers: 'إضافة عملائي وتعديلهم', order: 'إنشاء طلب لعميل', quote: 'عروض الأسعار' },
