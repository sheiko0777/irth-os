  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-2 gap-4 md:grid-cols-4 mb-6'>
        <StatBox label={t('summary.total')} value={sum.total} />
        <StatBox label={t('summary.active')} value={sum.active} />
        <StatBox label={t('summary.totalIssued')} value={formatAmount(sum.totalIssued)} />
        <StatBox label={t('summary.activeBalance')} value={formatAmount(sum.activeBalance)} />
      </div>
