 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * A byte-for-byte copy lives at apps/admin/src/server/services/eta.ts. It
 * should be ONE shared module (e.g. a `packages/eta` workspace package both
 * apps depend on), and was not made one here because linking a NEW workspace
