...
- **`schema-guard`** blocks PRs that touch `packages/db/drizzle/**`, `packages/db/src/schema/**`, `packages/db/src/index.ts`, `packages/db/src/orgContext.ts`, `packages/db/src/permissions.ts` or the tenancy/RLS gate tests unless the PR carries `exec:claude` or `schema:approved`; `exec:ui` PRs may not touch `apps/admin/src/server/**`.
